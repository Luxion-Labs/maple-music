<script lang="ts">
	...
	// loading state (every home response carries the same chips anyway). Maple is music-only.
	 ...
	 * the user actually plays *in Maple*. Swap its items for community playlists searched from
