...
const FEATURES = [
  {
    ...
    title: 'No ads, ever',
    body: 'Maple plays the audio stream directly, so there is nothing to interrupt. No ad breaks, no premium subscription.',
  },
  {
...
const SCREENS = [
  {
    ...
    img: screenLyrics,
    alt: 'Maple showing time-synced lyrics',
  },
  {
    eyebrow: 'Browse',
    ...
    img: screenArtist,
    alt: 'An artist page in Maple with top songs and albums',
  },
  {
    eyebrow: 'Together',
    ...
    img: screenTogether,
    alt: 'The Listen Together dialog in Maple',
  },
]
      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-36 pb-20 text-center sm:px-6 sm:pt-44">
        ...
        <FadeContent duration={900} delay={400}>
          <p className="mx-auto mt-6 max-w-2xl text-base text-muted-foreground sm:text-lg">
            Maple is a lightweight desktop player for YouTube Music. Search any song, hit play, and
        ...
        <AnimatedContent distance={80} duration={1.1} delay={0.25} scale={0.96} threshold={0}>
          <div className="mt-16">
            <img
              src={screenPlaylist}
              alt="Maple playing a playlist, with the queue open"
              width={1920}
              height={1043}
...
function Features() {
  return (
    <section id="features" className="mx-auto max-w-6xl scroll-mt-20 px-4 py-24 sm:px-6">
      <FadeContent duration={800}>
        <p className="text-center text-xs font-semibold tracking-widest text-primary-bright uppercase">Why Maple</p>
  ...
  return (
    <section id="download" className="mx-auto max-w-6xl scroll-mt-20 px-4 py-24 sm:px-6">
      <FadeContent duration={800}>
        ...
        <h2 className="mt-3 text-center font-heading text-3xl font-bold tracking-tight sm:text-4xl">Get Maple</h2>
    ...
    <footer className="border-t border-white/5">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-4 py-10 text-center text-sm text-muted-foreground sm:px-6">
        ...
        <p className="max-w-2xl text-xs leading-relaxed">
          Maple is an unofficial, open-source client and is not affiliated with or endorsed by
