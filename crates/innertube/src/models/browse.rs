...
///
/// YouTube stores this choice itself, which is why Maple asks for a sorted page instead of
...
pub enum PlaylistSort {
    ...
    Artist,
    Album,
    /// YouTube's "Top voted". Maple's own menu does not offer it, but a list can already be in
