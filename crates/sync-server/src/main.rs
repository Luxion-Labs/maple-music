//! Maple "Listen Together" sync server. A self-hosted WebSocket hub that relays small playback
...
async fn main() {
    ...
    tracing::info!(%addr, "maple-sync listening (plain ws — front with Tailscale/Cloudflare for wss)");
