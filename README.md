...
<img src="./assets/docs/maple-github-image.png" alt="Maple Banner" width="100%">
...
<p align="center">
  <a href="https://github.com/dev-Ninjaa/maple.music/releases/latest"><img alt="GitHub Downloads" src="https://img.shields.io/github/downloads/dev-Ninjaa/maple.music/total?style=for-the-badge&label=DOWNLOADS&color=a4c400"></a>
  <a href="https://github.com/dev-Ninjaa/maple.music/releases/latest"><img alt="GitHub Release" src="https://img.shields.io/github/v/release/dev-Ninjaa/maple.music?display_name=release&style=for-the-badge&color=a10935"></a>
  <img alt="License" src="https://img.shields.io/github/license/dev-Ninjaa/maple.music?style=for-the-badge&color=1881cc">
  <br>
...
**Maple** talks directly to YouTube's internal API and plays audio through libmpv — no bundled
...
<p align="center">
  <a href="https://github.com/dev-Ninjaa/maple.music/releases/latest">
...
- **Last.fm** — click the Last.fm mark, approve Maple in the browser tab that
...
```
MAPLE_LASTFM_API_KEY=your_key
MAPLE_LASTFM_API_SECRET=your_secret
```
...
- YouTube's stream URLs are protected by obfuscated JavaScript (the signature
  cipher and the `n` parameter) and by BotGuard attestation. Maple runs that
